...
//
//public class SaxParserCopy implements Parser {
//    private Logger log = org.slf4j.LoggerFactory.getLogger(SaxParserCopy.class);
//    private Map<String, MethodHandle> configuration;
//    private Map<Class, Function<String, ?>> converter;
//
//    @Override
//    public <T> T parse(File file, Class clazz) {
//        return null;
//    }
//
...
//    }
//
//    public <T> T parseBeer(File file, Class clazz) throws ParserException {
...
//        }
//
//        return beerHandler.getResult();
//    }
//
//
//    private class BeerHandler extends DefaultHandler {
//        private Beer beer;
...
//                if (mh != null) {
//                    mh.invoke(beer, converter.get(mh.type().parameterType(1)).apply(charaster.toString()));
//                }
